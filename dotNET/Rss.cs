...
namespace XiboClient
{
    class Rss : Media
    {
            ...
            : base(options.width, options.height, options.top, options.left)
        {
            ...
            document = String.Format("<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /><style type='text/css'>body {{{1}}}, p, h1, h2, h3, h4, h5 {{ margin:2px; font-size:{0}em; }}</style></head><body></body></html>", options.scaleFactor.ToString(), bodyStyle);
